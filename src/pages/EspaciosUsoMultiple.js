...
const [exito, setExito] = useState(false);
  ...
  const handleEventAdd = async (data) => {
    ...
    const buscarTipo = async() => {
      ...
      setData((rtdo.data.data).filter(artista=> artista.space.spaceTypeId === "33"));
    }
...
console.log(info);
	...
	<div class="row no-gutters fixed-top">
      ...
      <div className='verde text-center'>  <h1>Reservar Salas Uso Multiple</h1></div>
...
export default EspaciosUsoMultiple;
