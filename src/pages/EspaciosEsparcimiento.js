...
function EspaciosEsparcimiento() {
...
const [exito, setExito] = useState(false);
  ...
  const handleEventAdd = async (data) => {
    ...
    const buscarTipo = async() => {
      ...
      setData((rtdo.data.data).filter(artista=> artista.space.spaceTypeId === "32"));
    }
...
console.log(info);
	...
	<div class="row no-gutters fixed-top">
      ...
      <div className='verde text-center'>  <h1>Reservar Espacio Esparcimiento</h1></div>
...
export default EspaciosEsparcimiento;
